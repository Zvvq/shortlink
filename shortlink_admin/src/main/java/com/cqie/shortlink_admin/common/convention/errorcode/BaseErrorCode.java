package com.cqie.shortlink_admin.common.convention.errorcode;
...
public enum BaseErrorCode implements IErrorCode {
    ...
    USER_NOT_EXIST_ERROR("A000151", "用户不存在"),
    USER_EXIST_ERROR("A000152", "用户已存在"),
    USER_SAVE_ERROR("A000153", "用户保存失败"),
    USERNAME_NULL_ERROR("A000154", "用户名为空"),
    USER_LOGIN_ERROR("A000155", "用户名或密码错误 "),
